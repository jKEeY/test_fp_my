...
!(function (e, t) {
  ...
  var t = function () {
    ...
    o = function (e, t) {
      ...
      else for (var o in e) e.hasOwnProperty(o) && t(e[o], o);
    },
    i = function (e, t) {
      var n = [];
      return null == e
  ...
  var p = (function () {
    ...
    return (
      Object.defineProperty(e.prototype, "tls", {
        set: function (e) {
          this._tls = e;
        },
        enumerable: !1,
      ...
      (e.prototype.buildRaw = function (e) {
        ...
        return (
          this._tls && this._tls.length > 0 && (n.j = this._tls),
          ...
          this.sendOptions.linkedId &&
            (n.lid = this.sendOptions.linkedId.toString()),
  ...
  function S(e, t) {
    console.log("S275", e, t)((e._state = 2)), (e._value = t), _(e);
  }
  ...
  (w.prototype.catch = function (e) {
    ...
    (w.race = function (e) {
      return new w(function (t, n) {
        ...
        for (var r = 0, o = e.length; r < o; r++) w.resolve(e[r]).then(t, n);
      });
    }),
    (w._immediateFn =
  ...
  "Promise" in C
    ? C.Promise.prototype.finally || (C.Promise.prototype.finally = g)
    : (C.Promise = w);
  var T,
    E,
    O = function (e, t) {
    ...
    L = function () {
      return (function (e, t) {
        ...
        for (
          ...
          (a = [
            (255 & e.charCodeAt(f + 4)) |
              ((255 & e.charCodeAt(f + 5)) << 8) |
              ((255 & e.charCodeAt(f + 6)) << 16) |
              ((255 & e.charCodeAt(f + 7)) << 24),
            (255 & e.charCodeAt(f)) |
            ...
            (c = [
              (255 & e.charCodeAt(f + 12)) |
                ((255 & e.charCodeAt(f + 13)) << 8) |
                ((255 & e.charCodeAt(f + 14)) << 16) |
                ((255 & e.charCodeAt(f + 15)) << 24),
              (255 & e.charCodeAt(f + 8)) |
                ((255 & e.charCodeAt(f + 9)) << 8) |
                ((255 & e.charCodeAt(f + 10)) << 16) |
                ((255 & e.charCodeAt(f + 11)) << 24),
            ]),
            (a = I(a, u)),
            (a = x(a, 31)),
            (a = I(a, s)),
    ...
    q = function () {
      return new Promise(function (e, t) {
        for (var n = u(100), r = [], o = 0; o < 1e3; o++) r.push(n);
        var i = r.join(),
          a = [];
        try {
          for (var c = 0; c < 30; c++) {
            var s = u(10);
            localStorage.setItem(s, i), a.push(s);
          }
          return e(!0);
        } catch (t) {
          return e(!1);
    ...
    ie = {
      ...
      k5: function (e) {
        e(
          [
            parseInt(te.screen.width.toString()),
            parseInt(te.screen.height.toString()),
          ]
            .sort()
            .reverse()
        );
      ...
      k6: function (e) {
        te.screen.availWidth && te.screen.availHeight
          ? e(
              [
                parseInt(te.screen.availHeight.toString()),
                parseInt(te.screen.availWidth.toString()),
              ]
                .sort()
                .reverse()
            )
      ...
      k9: function (e) {
        var t;
        te.Intl &&
          te.Intl.DateTimeFormat &&
          (t = new te.Intl.DateTimeFormat().resolvedOptions().timeZone),
          e(t);
      },
      k10: function (e) {
        var t = 1;
      ...
      k20: function (e) {
        !(function (e) {
          var t = ["monospace", "sans-serif", "serif"],
            ...
            f = function (e) {
              for (var n = !1, r = 0; r < t.length; r++)
                if (
                  (n =
                    e[r].offsetWidth !== a[t[r]] ||
                    e[r].offsetHeight !== c[t[r]])
                )
                  return n;
              return n;
            },
          ...
          for (var d = 0, h = t.length; d < h; d++)
            (a[t[d]] = l[d].offsetWidth), (c[t[d]] = l[d].offsetHeight);
          var p = (function () {
          ...
          o(
            ...
            function (e) {
              void 0 !== i[e[0]] &&
                ...
                i[e[0]].setValueAtTime(e[1], n.currentTime);
            }
          ),
            r.connect(i),
      ...
      k29: function (e) {
        re.permissions
          ...
          .then(function (t) {
            "denied" === Notification.permission && "prompt" === t.state
              ? e(1)
              : e(0);
          });
      },
      k30: function (e) {
        var t = [
          "webdriver" in te,
          "_Selenium_IDE_Recorder" in te,
          "callSelenium" in te,
          "_selenium" in te,
          "__webdriver_script_fn" in ne,
          "__driver_evaluate" in ne,
          "__webdriver_evaluate" in ne,
          "__selenium_evaluate" in ne,
          "__fxdriver_evaluate" in ne,
          "__driver_unwrapped" in ne,
          "__webdriver_unwrapped" in ne,
          "__selenium_unwrapped" in ne,
          "__fxdriver_unwrapped" in ne,
          "__webdriver_script_func" in ne,
          null !== ne.documentElement.getAttribute("selenium"),
          null !== ne.documentElement.getAttribute("webdriver"),
          null !== ne.documentElement.getAttribute("driver"),
        ];
        o(t, function (t) {
          t && e(1);
        }),
          ...
          (function () {
            ...
            try {
              ...
              return (
                -1 != u &&
                1321 !=
                  i.slice(u + 5, s).reduce(function (e, t) {
                    return e + t;
                  }, 0)
              );
            } catch (e) {
    ...
    return new Promise(function (n, r) {
      !(function (e, t, n) {
        ...
        btn.addEventListener("click", function () {
          const span = document.getElementById("jso");
          span.innerHTML = JSON.stringify(t);
        });
          ...
          (r.onreadystatechange = function () {
            ...
            r.readyState == XMLHttpRequest.DONE &&
              (r.status >= 200 && r.status < 300
                ? o(null, r.responseText)
                : 404 === r.status || r.status >= 500
                ? o(r.statusText)
                : r.status > 300 && o(r.responseText));
          });
        try {
  ...
  var ce = (function () {
      ...
      return (
        Object.defineProperty(e.prototype, "ip", {
          get: function () {
    ...
    le = function (e) {
      ...
      var t = "api.fpjs.io";
      return (
        e.region && "us" != e.region && (t = e.region + "." + t), "https://" + t
      );
    },
    de = (function () {
      function e(e) {
      ...
      return (
        ...
        Object.defineProperty(e.prototype, "loaded", {
          get: function () {
            return (e = this.properties.loaded) &&
              e.constructor &&
              e.call &&
              e.apply
