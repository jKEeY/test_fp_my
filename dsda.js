...
!function(e, t) {
    "object" == typeof exports && "undefined" != typeof module ? t(exports) : "function" == typeof define && define.amd ? define(["exports"], t) : t((e = e || self).FP = {})
}(this, (function(e) {
    "use strict";
    var t = function() {
    ...
    function f(e, t, n) {
        return "n/a" !== e && (!function(e, t, n, r) {
            ...
            document.cookie = [o, "path=/", a, c].join("; ")
        }(n || "_vid", e, 365, t),
        h("_vid", e)),
        e
    }
    ...
    var p = function() {
        ...
        e.prototype.buildRaw = function(e) {
            ...
            return this._tls && this._tls.length > 0 && (n.j = this._tls),
            this._tlsError && (n.je = this._tlsError),
            this.sendOptions.tag && (n.t = this.sendOptions.tag),
            this.sendOptions.callbackData && (n.cbd = 1),
            this.sendOptions.linkedId && (n.lid = this.sendOptions.linkedId.toString()),
            document.referrer && (n.cr = document.referrer),
            o(this.components, (function(e) {
                n[e.key] = e.value
            }
            )),
            n
    ...
    function k(e, t) {
        ...
        w._immediateFn((function() {
            ...
            if (null !== n) {
                ...
                (1 === e._state ? b : S)(t.promise, e._value)
        }
        ))) : e._deferreds.push(t)
    }
    function b(e, t) {
    ...
    w.prototype.then = function(e, t) {
        ...
        return k(this, new P(e,t,n)),
        n
    }
    ,
    w.prototype.finally = g,
    w.all = function(e) {
    ...
    var T, E, O = function(e, t) {
        ...
        return function(e, t) {
            t = t || 0;
            for (var n = (e = e || "").length % 16, r = e.length - n, o = [0, t], i = [0, t], a = [0, 0], c = [0, 0], u = [2277735313, 289559509], s = [1291169091, 658871167], f = 0; f < r; f += 16)
                ...
                c = [255 & e.charCodeAt(f + 12) | (255 & e.charCodeAt(f + 13)) << 8 | (255 & e.charCodeAt(f + 14)) << 16 | (255 & e.charCodeAt(f + 15)) << 24, 255 & e.charCodeAt(f + 8) | (255 & e.charCodeAt(f + 9)) << 8 | (255 & e.charCodeAt(f + 10)) << 16 | (255 & e.charCodeAt(f + 11)) << 24],
                a = I(a, u),
                a = x(a, 31),
                a = I(a, s),
                o = M(o, a),
        ...
        !function() {
            (T = document.createElement("canvas")).width = 240,
            T.height = 140,
        ...
        return E && T.toDataURL ? (E.rect(0, 0, 10, 10),
        E.rect(2, 2, 6, 6),
        e.winding = !1 === E.isPointInPath(5, 5, "evenodd"),
        E.textBaseline = "alphabetic",
        E.fillStyle = "#f60",
        E.fillRect(125, 1, 62, 20),
        E.fillStyle = "#069",
        E.font = "11pt no-real-font-123",
        E.fillText("Cwm fjordbank 😃 gly", 2, 15),
        E.fillStyle = "rgba(102, 204, 0, 0.2)",
        E.font = "18pt Arial",
        E.fillText("Cwm fjordbank 😃 gly", 4, 45),
    ...
    }, N = navigator, F = window, H = navigator, U = window, q = function() {
        return new Promise((function(e, t) {
            for (var n = u(100), r = [], o = 0; o < 1e3; o++)
                r.push(n);
            var i = r.join()
              , a = [];
            try {
        ...
        try {
            ...
            }() : "MozAppearance"in document.documentElement.style ? new Promise((function(e, t) {
                try {
    ...
    }, te = window, ne = document, re = navigator, oe = [{
        key: "k1"
    }, {
        key: "k2"
    }, {
        ...
        k2: function(e) {
            var t = [[re.language || re.userLanguage || re.browserLanguage || re.systemLanguage]];
            if (Array.isArray(re.languages))
                t.push(re.languages);
        ...
        k5: function(e) {
            e([parseInt(te.screen.width.toString()), parseInt(te.screen.height.toString())].sort().reverse())
        },
        k6: function(e) {
            te.screen.availWidth && te.screen.availHeight ? e([parseInt(te.screen.availHeight.toString()), parseInt(te.screen.availWidth.toString())].sort().reverse()) : e([])
        },
        k7: function(e) {
            try {
        ...
        k9: function(e) {
            var t;
            te.Intl && te.Intl.DateTimeFormat && (t = (new te.Intl.DateTimeFormat).resolvedOptions().timeZone),
            e(t)
        },
        k10: function(e) {
            var t = 1;
        ...
        k19: function(e) {
            e(function() {
                var e, t = 0;
                void 0 !== N.maxTouchPoints ? t = N.maxTouchPoints : void 0 !== N.msMaxTouchPoints && (t = N.msMaxTouchPoints);
                try {
        ...
        k20: function(e) {
            !function(e) {
                var t = ["monospace", "sans-serif", "serif"]
                  ...
                  , f = function(e) {
                    for (var n = !1, r = 0; r < t.length; r++)
                        if (n = e[r].offsetWidth !== a[t[r]] || e[r].offsetHeight !== c[t[r]])
                            return n;
                    return n
                }
                  , l = function() {
                ...
                for (var d = 0, h = t.length; d < h; d++)
                    a[t[d]] = l[d].offsetWidth,
                    c[t[d]] = l[d].offsetHeight;
                var p = function() {
        ...
        k21: function(e) {
            !function(e) {
                if (H.userAgent.match(/OS 11.+Version\/11.+Safari/))
                    return e(-1);
                ...
                r.type = "triangle",
                r.frequency.setValueAtTime(1e4, n.currentTime);
        ...
        k33: function(e) {
            e(function() {
                ...
                try {
                    ...
                    return -1 != u && 1321 != i.slice(u + 5, s).reduce((function(e, t) {
                        return e + t
                    }
                    ), 0)
                } catch (e) {
    ...
    var ce = function() {
      ...
      , ue = function() {
        function e(e) {
            se(e),
            this.config = e,
            this.config.timeoutDelay = e.timeoutDelay || 50
        }
            ...
            return new Promise((function(r, o) {
                ...
                var c = a ? new Promise((function(e, t) {
                    ...
                    n.onreadystatechange = function() {
                        n.readyState == XMLHttpRequest.DONE && (clearTimeout(r),
                        200 == n.status ? e(n.responseText) : n.status >= 300 && t(n.responseText))
                    }
                    ;
                    try {
                        n.send()
                ...
                !function(e) {
                    ...
                    c.then((function(e) {
                        ...
                        ae(le(t.config), s.buildRaw(t.config.cookieKey)).then((function(e) {
                            if (e.error)
                                return o(e);
                            f(e.visitorId, t.config.cookieDomain, t.config.cookieKey),
                            clearTimeout(i),
                            r(fe(e, n.tag))
                        }
                        )).catch((function(e) {
      ...
      , le = function(e) {
        if (e.endpoint)
            return e.endpoint;
        var t = "api.fpjs.io";
        return e.region && "us" != e.region && (t = e.region + "." + t),
        "https://" + t
    }
      , de = function() {
        function e(e) {
    ...
    pe.then((function(e) {
        ...
        he.autoSend && (a("Configuration snippet is missing or invalid"),
        a(e))
    }
    )),
    e.NotAvailable = "n/a",
    ...
    e.send = function(e) {
        return e && e.debug && a("Using the global FP object is deprecated and will be removed in v3 of the agent."),
